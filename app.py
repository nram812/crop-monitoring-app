...
def update_pre_callback(filename, foo_click_data,time_slider):
    delta = 0.05
    try:
        foo_click_data = foo_click_data['points'][0]['lat'], foo_click_data['points'][0]['lon']
    ...
    trace4 = trace2#go.Scatter(x=index, y=[xdata2[filename]], mode='markers+text',
